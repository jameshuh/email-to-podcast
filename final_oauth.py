...
# 用户提供的完整 URL
REDIRECT_URL = "http://localhost:8080/?state=J42h04p1eYcPOXEeLlPBGVIsclkS5a&code=4/0AfrIepAHd08oKIvhghB-VJvMADWlCvui_K1vIEtmLuzmYKFHiciTIPGHQcR3nKMp0XIFig&scope=https://www.googleapis.com/auth/gmail.readonly"
